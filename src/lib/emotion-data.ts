...
export const EMOTIONS: Emotion[] = [
    ...
    { chinese: '受到驚嚇的', english: 'Stunned', quadrant: 'red', energy: 'high', pleasantness: 'low' },
    { chinese: '憤怒的', english: 'Fuming', quadrant: 'red', energy: 'high', pleasantness: 'low' },
    { chinese: '害怕的', english: 'Frightened', quadrant: 'red', energy: 'high', pleasantness: 'low' },
    { chinese: '生氣的', english: 'Angry', quadrant: 'red', energy: 'high', pleasantness: 'low' },
    { chinese: '緊張的', english: 'Nervous', quadrant: 'red', energy: 'high', pleasantness: 'low' },
    { chinese: '坐立不安的', english: 'Restless', quadrant: 'red', energy: 'high', pleasantness: 'low' },
    { chinese: '焦慮的', english: 'Anxious', quadrant: 'red', energy: 'high', pleasantness: 'low' },
    { chinese: '忐忑的', english: 'Apprehensive', quadrant: 'red', energy: 'high', pleasantness: 'low' },
    ...
    { chinese: '暴食的', english: 'Binge Eating', quadrant: 'red', energy: 'high', pleasantness: 'low' },
    ...
    { chinese: '愉悅的', english: 'Joyful', quadrant: 'yellow', energy: 'high', pleasantness: 'high' },
    { chinese: '專注的', english: 'Focused', quadrant: 'yellow', energy: 'high', pleasantness: 'high' },
    { chinese: '流暢的', english: 'Smooth', quadrant: 'yellow', energy: 'high', pleasantness: 'high' },
    { chinese: '流動的', english: 'Flowing', quadrant: 'yellow', energy: 'high', pleasantness: 'high' },
    { chinese: '自由的', english: 'Free', quadrant: 'yellow', energy: 'high', pleasantness: 'high' },
    ...
    { chinese: '充滿愛的', english: 'Loving', quadrant: 'green', energy: 'low', pleasantness: 'high' },
    { chinese: '幸福的', english: 'Fulfilled', quadrant: 'green', energy: 'low', pleasantness: 'high' },
    { chinese: '清靜的', english: 'Calm', quadrant: 'green', energy: 'low', pleasantness: 'high' },
    ...
    { chinese: '想睡的', english: 'Sleepy', quadrant: 'green', energy: 'low', pleasantness: 'high' },
    { chinese: '得意的', english: 'Complacent', quadrant: 'green', energy: 'low', pleasantness: 'high' },
